...
public class PermissionController {
	...
	@PostMapping("/assign")
	public ResponseEntity<?> assignPermission(@RequestBody List<Permission> permissions) {
	...
	@GetMapping("/{moduleId}")
	public ResponseEntity<?> getProjectById(@PathVariable String moduleId) {
	...
	@GetMapping("/all")
	public Iterable<Permission> getAllProjects() {
